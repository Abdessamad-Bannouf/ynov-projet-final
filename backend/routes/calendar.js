...
router.post('/create', requireAuth, requireRole('rh','recruiter','admin'), sanitize, calendarController.create);
router.post('/update', requireAuth, requireRole('rh','recruiter','admin'), sanitize, calendarController.update);
