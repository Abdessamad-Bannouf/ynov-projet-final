...
router.post('/', requireAuth, requireRole('rh','recruiter','admin'), sanitize, interviewController.create);
router.put('/:id', requireAuth, requireRole('rh','recruiter','admin'), sanitize, interviewController.update);
