...
router.post('/', requireAuth, requireRole('recruiter','rh','admin'), feedbackController.create);

router.get('/:id', requireAuth, requireRole('rh','recruiter','admin'), feedbackController.show);

router.put('/:id', requireAuth, requireRole('recruiter','rh','admin'), feedbackController.update);
